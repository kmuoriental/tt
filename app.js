...
window.exportPDF = function() {
    ...
    if (mode === 'exam') {
        doc.text("Oriental Exam Invigilation Schedule", 14, 15);
        ...
        const day = document.getElementById('subDay').value;
        doc.text(`Oriental Substitution Duty - ${selectedDate} (${day})`, 14, 15);
    ...
    doc.save(`Oriental_Schedule_${selectedDate}.pdf`);
};
